...
export class init1689323701558 implements MigrationInterface {
    name = 'init1689323701558'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "deposit" ("deposit_id" SERIAL NOT NULL, "deposit_user_id" integer NOT NULL, "deposit_credit" numeric DEFAULT '0', "deposit_debit" numeric DEFAULT '0', "deposit_desc" text, "deposit_created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_09011c3a488508ec9ffd4e8bc26" PRIMARY KEY ("deposit_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "item" ("item_id" SERIAL NOT NULL, "item_user_id" integer, "item_name" text NOT NULL, "item_start_price" numeric, "item_end_price" numeric, "item_time_window" numeric NOT NULL DEFAULT '1', "item_created_by" integer NOT NULL, "item_status" text NOT NULL DEFAULT 'Pending', "item_created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "item_published_at" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_8b21aa99996acd87a00c0ce553a" PRIMARY KEY ("item_id"))`);
        await queryRunner.query(`CREATE TABLE "bid" ("bid_id" SERIAL NOT NULL, "bid_item_id" integer NOT NULL, "bid_user_id" integer NOT NULL, "bid_price" numeric NOT NULL, "bid_winner" boolean NOT NULL DEFAULT false, "bid_created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), CONSTRAINT "PK_8119bf86e5b937fdf2140e28e8f" PRIMARY KEY ("bid_id"))`);
